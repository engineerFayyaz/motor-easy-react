      ...
      <div className="row d-flex flex-row">
        <div className="col-lg-7">
          <div className="p-4" style={{ backgroundColor: "white" }}>
            ...
            <p style={{ fontSize: 14 }}>
              ...
              tirelessly to maintain state-of-the-art security, ensuring that
              your data remains protected within our secure systems.
            </p>
          </div>
          <div className="row">
            <div
            ...
            >
              ...
              <div className="two_step_button d-flex justify-content-between mt-5">
                ...
                <button className="text-end">Next step -my warrenty</button>
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-5 ">
          ...
          <div className="section_number_2 d-flex flex-column">
            ...
            <div
              className="row d-flex flex-column mt-4"
            >
